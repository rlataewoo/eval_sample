...
def generate_classifier_block(sample_num, transcript):
    ...
    audio_a_url = f"https://rlataewoo.github.io/eval_sample/samples/table_3/gigaspeech_mp3/{sample_id}_A.mp3?raw=true"
    audio_b_url = f"https://rlataewoo.github.io/eval_sample/samples/table_3/gigaspeech_mp3/{sample_id}_B.mp3?raw=true"
    audio_ref_url = f"https://rlataewoo.github.io/eval_sample/samples/table_3/gigaspeech_mp3/{sample_id}_Ref.mp3?raw=true"
...
generate_hit_file("hit_cmos_2.html", 1, 40, transcript_map)
